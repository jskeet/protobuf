...
namespace Google.Protobuf.Reflection
{
    ...
    internal sealed class DescriptorPool
    {
        ...
        /// <summary>
        /// Adds an enum value to the enumValuesByNumber and enumValuesByName table. If an enum value
        ...
        private struct EnumValueByNameDescriptorKey : IEquatable<EnumValueByNameDescriptorKey>
        {
            ...
            public override bool Equals(object obj) => obj is EnumValueByNameDescriptorKey pair && Equals(pair);
